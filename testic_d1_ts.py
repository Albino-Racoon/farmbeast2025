...
rospy.init_node('object_detection_sound', anonymous=True)
bridge = CvBridge()
                ...
                for box in result.boxes:
                    ...
                    if conf > 0.3:
                        ...
                        if closest_tracked is None:
                            ...
                            # Predvajaj zvok
                            subprocess.run("bash /home/rakun/Desktop/Yolo_det_once/sounds/play.sh /home/rakun/Desktop/Yolo_det_once/man-scream-121085.mp3", shell=True)
                        else:
